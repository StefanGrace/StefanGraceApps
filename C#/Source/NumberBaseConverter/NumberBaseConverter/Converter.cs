...
namespace NumberBaseConverter
{
    class BaseConverter
    {
        public static string ConvertBase(string input, int inputBase, int outputBase, DigitSeperation outputDigitSeperation)
        {
            ...
            // Add digit seperators
            if (outputDigitSeperation.UseSeperator)
            {
                if (outputDigitSeperation.Integer)
                {
                    string integerOutputStringLE = new string(integerOutputString.Reverse().ToArray());
                    string outputStringWithSeperatorsLE 
                        = AddSeperators(integerOutputStringLE, outputDigitSeperation.Seperator, outputDigitSeperation.Digits);
                    integerOutputString = new string(outputStringWithSeperatorsLE.Reverse().ToArray());
                }

                if (outputDigitSeperation.Fraction)
                {
                    fractionOutputString = AddSeperators(fractionOutputString, outputDigitSeperation.Seperator, outputDigitSeperation.Digits);
                }
            }
