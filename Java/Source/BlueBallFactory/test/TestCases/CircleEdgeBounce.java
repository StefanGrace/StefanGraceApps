...
/**
 * Test Case: Circle Edge bounce
 * Expected outcome: when the circle hits the edge of the canvas it will bounce
 * 
 * @author Stefan
 */
public class CircleEdgeBounce extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CircleEdgeBounce
     */
    public CircleEdgeBounce() {
        initComponents();
        ...
        circles.get(0).setSpeedX(7);
        circles.get(0).setSpeedY(5);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Test Case: Circle Edge Bounce");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CircleEdgeBounce.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CircleEdgeBounce().setVisible(true);
            }
        });
    }
